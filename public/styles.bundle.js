...
// module
exports.push([module.i, "/* You can add global styles to this file, and also import other style files */\na:not([href]) {\n  cursor: pointer;\n  -webkit-user-select: none;\n  -moz-user-select: none;\n  -ms-user-select: none;\n      user-select: none; }\n\n/* Modified Japanese Cube pattern, source: http://lea.verou.me/css3patterns/  */\n.user-level {\n  color: #02E148;\n  background-color: #0f0f0f;\n  border-radius: 6px; }\n\n.user-level.btn {\n  -ms-box-shadow: 0.6vw 0.4vh 10px black;\n  box-shadow: 0.6vw 0.4vh 10px black; }\n\n#multifeed-div :host /deep/ ul.nav.nav-tabs {\n  position: fixed;\n  top: 16vh;\n  -ms-box-shadow: 2px 4px 20px #0f0f0f;\n  box-shadow: 2px 4px 20px #0f0f0f; }\n  #multifeed-div :host /deep/ ul.nav.nav-tabs .tab-style {\n    background: -webkit-linear-gradient(265deg, #e8eef7, #9cb6dd);\n    background: linear-gradient(185deg, #e8eef7, #9cb6dd); }\n    #multifeed-div :host /deep/ ul.nav.nav-tabs .tab-style a {\n      color: black;\n      font-size: 16px;\n      font-weight: bold; }\n", ""]);
